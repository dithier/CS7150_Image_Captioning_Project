...
from pytorch_decoder_only.pytorch_decoder_only_model import VisionTransformerDecoderModel
import os
...
def main(opt):
    ...
    model = VisionTransformerDecoderModel(vocab, P, embed_dim, num_heads,
                                          trx_ff_dim, num_decoder_cells, dropout)
