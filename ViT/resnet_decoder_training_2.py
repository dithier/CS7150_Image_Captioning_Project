...
from resnet_transformer import ResnetTransformerModel
import os
    ...
    for epoch_i in range(curr_epoch, total_epochs + 1):
        ...
        for i, batch_data in enumerate(train_data_loader):
            ...
            if (i > 1 and i % print_save_freq == 0) or i == len(train_data_loader) - 1:
                ...
                avg_val_loss = get_avg_validation_transformer_teacher_loss(model, val_data_loader, loss_fn, vocab)
...
def main(opt):
    ...
    # start with lr = 1e-4, weight decay = 1e-4
    if opt.checkpoint:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--print_freq", type=int, default=250, help="how many batches go by in between save and prints")
