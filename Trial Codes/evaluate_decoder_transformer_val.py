...
from transformer_dec_only_model import VisionTransformerDecoderModel

"""
Evaluate a saved decoder-only transformer checkpoint on the VALIDATION set.
Supports BLEU-1 through BLEU-4, METEOR, CIDEr-D, and CIDEr per n-gram order.

Usage:
    # all metrics (default)
    python evaluate_decoder_transformer_val.py --checkpoint_path saved_models/decoder_only_pass_6/model.pt

    # single metric
    python evaluate_decoder_transformer_val.py --checkpoint_path saved_models/decoder_only_pass_6/model.pt --metric bleu
"""
