"""
Caption a single image using baseline_model_v1 (WITHOUT learned c0 init layer, c0 = zeros).
Use this for checkpoints trained with baseline_model_v1.py (e.g. adam_pass_1, adam_pass_2, adam_pass_4).

Usage:
    python caption_v1_no_c.py --image_path path/to/image.jpg --checkpoint_path saved_models/xxx/model.pt
"""
import torch
import argparse
...
def main(opt):
    ...
    print(f"Model : baseline_model_v1 (c0 = zeros, no learned init)")
