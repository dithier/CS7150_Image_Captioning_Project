...
"""
Evaluate Carter's PyTorch enc-dec transformer checkpoint on the VALIDATION set.
Uses pytorch_transformer_enc_dec_model.py (nn.TransformerEncoder/Decoder internals).
...
Usage:
    # all metrics (default)
    python evaluate_pytorch_transformer_val.py --checkpoint_path "saved_models/Carter Models/overfit_model_30_epochs.pt"

    # single metric
    python evaluate_pytorch_transformer_val.py --checkpoint_path "saved_models/Carter Models/overfit_model_30_epochs.pt" --metric bleu
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_path", type=str, required=True,
                        help="path to saved pytorch enc-dec transformer checkpoint")
